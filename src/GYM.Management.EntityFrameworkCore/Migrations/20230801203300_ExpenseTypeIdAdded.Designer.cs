...
namespace GYM.Management.Migrations
{
    ...
    [Migration("20230801203300_ExpenseTypeIdAdded")]
    partial class ExpenseTypeIdAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GYM.Management.Exercises.Exercise", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GYM.Management.Losses.Loss", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GYM.Management.MemberOrders.MemberOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<int>("AppointmentStock")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("MemberOrderType")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GYM.Management.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GYM.Management.Wallets.Wallet", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GYM.Management.ExerciseCategories.ExerciseCategory", b =>
                {
                    ...
                    b.HasOne("GYM.Management.Exercises.Exercise", "Exercise")
                        .WithMany("ExerciseCategories")
            ...
            modelBuilder.Entity("GYM.Management.Expenses.Expense", b =>
                {
                    b.HasOne("GYM.Management.ExpenseTypes.ExpenseType", "ExpenseType")
                        .WithMany()
            ...
            modelBuilder.Entity("GYM.Management.MemberOrders.MemberOrder", b =>
                {
                    ...
                    b.HasOne("GYM.Management.Products.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("GYM.Management.WalletTransactions.WalletTransaction", b =>
                {
                    b.HasOne("GYM.Management.Wallets.Wallet", "Wallet")
            ...
            modelBuilder.Entity("GYM.Management.Wallets.Wallet", b =>
                {
                    b.HasOne("GYM.Management.Trainers.Trainer", "Trainer")
                        .WithOne("Wallet")
                        .HasForeignKey("GYM.Management.Wallets.Wallet", "TrainerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
